						...
						<div class="row">
							<div class="col-md-12">
								<div class="contact-info-wrap-flex">
									<div class="con-info">
										<p><span><i class="icon-location-2"></i></span> 108 University Ave,<br> Waterloo, ON N2J 2W2</p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-phone3"></i></span> <a href="tel://1234567920">+ (519) 885-0300</a></p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-paperplane"></i></span> <a href="mailto:ykim0406@conestogac.on.ca">ykim0406@conestogac.on.ca</a></p>
									</div>
<!-- 									<div class="con-info"> -->
...
<!-- 									<input type="text" id="lname" class="form-control" placeholder="Your lastname"> -->
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" id="passwordString" class="form-control" placeholder="Password">
								</div>
							</div>
