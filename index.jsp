		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-md-2">
							<div id="colorlib-logo"><a href="index.jsp">GoNow</a></div>
						</div>
...
<!-- 								<li><a href="services.html">Services</a></li> -->
								<li><a href="customer.jsp"><font size=4>-Customer-</font></a></li>
							...
							<ul>
								<li><font color="orange">Filter by Event date	</font><font color="white">|</font></li>
								<li><a href="#"><font color="white">All	|</font></a></li>
								<li><a href="#"><font color="white">Today	|</font></a></li>
								<li><a href="#"><font color="white">This Week	|</font></a></li>
								<li><a href="#"><font color="white">This Month	|</font></a></li>
								<li><a href="#"><font color="white">This Year	|</font></a></li>
							</ul>
